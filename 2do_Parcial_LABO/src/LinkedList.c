...
/**
 * La función “ll_map” recibirá una lista y una función “pFunc”.
 * se deberán iterar todos los elementos de la lista y pasárselos a la función “pFunc” que recibirá el elemento y le calculará el
campo totalCompra, el retorno de “pFunc” se agregará a la lista resultado, esta nueva lista será
devuelta por ll_map.
 ...
 * La función “ll_filter” recibirá una lista y una función “pFunc”. se deberá iterar todos los
	...
	ítem se debe agregar a la lista resultado o 0 si no debe agregarse.
 * @param this Puntero a la lista
 * @param pFunc Puntero a funcion
 * @return generará la nueva lista resultado, agregará a la misma los ítems correspondientes y la devolverá.
 */
